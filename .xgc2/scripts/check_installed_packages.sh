...
check_ros_package() {
  ...
  test -f "${PREFIX}/share/${ros_package}/profiles/schema/robot-adapter-profile-v1.schema.json"
  ...
  python3 "$(dirname "$0")/../../tools/verify_runtime_manifests.py" \
    ...
    --profile-schema "${PREFIX}/share/${ros_package}/profiles/schema/robot-adapter-profile-v1.schema.json" \
