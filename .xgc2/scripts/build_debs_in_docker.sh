...
docker_env_args=(
  ...
  -e "XGC2_PROTOBUF_GIT_REF=${XGC2_PROTOBUF_GIT_REF:-17395aabbeb1987898dca3a8e7ee1a720ceb2ccf}"
  ...
  -e "XGC2_ADAPTER_RUNTIME_CLIENT_GIT_REF=${XGC2_ADAPTER_RUNTIME_CLIENT_GIT_REF:-362072586671e6d052fb5207b3bfe560ea26da43}"
)
